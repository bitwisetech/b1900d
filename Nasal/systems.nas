####B1900d systems
#### Syd Adams
##  polly: Prop in Beta range lights caution 
...
var Alarm = {
    ...
    "FXfer","Taxi","Lignition","Rignition","LFuelCol","RFuelCol","LBeta","RBeta"];
    m.warning_index=[];
    m.caution_index=[];
...
###############
    check_caution:func{
        ...
        smpl=0;
##polly
        if(getprop("controls/engines/engine[0]/propeller-pitch") < 0){
          smpl=1;me.MCaution.setValue(1);}
        me.caution_index[11].setValue(smpl);
        smpl=0;
        if(getprop("controls/engines/engine[1]/propeller-pitch") < 0){
          smpl=1;me.MCaution.setValue(1);}
        me.caution_index[12].setValue(smpl);
        smpl=0;
